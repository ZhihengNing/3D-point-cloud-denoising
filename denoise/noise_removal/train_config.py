...
class NoiseRemovalTrainConfig(BaseTrainConfig):
    def __init__(self):
        super().__init__(PointCleanNet.NOISE_REMOVAL)
        self.epoch = 500
        self.batch_size = 512 * len(GPU_LIST)
        self.patches_per_point_cloud = 700
    ...
    def training_parser_arguments(self):
        ...
        self.parser.add_argument('--lr', type=float, default=0.000001,
                                 help='learning rate')
        self.parser.add_argument('--momentum', type=float, default=0.9,
                                 help='gradient descent momentum')

    def model_hyperparameter_parser_arguments(self):
        self.parser.add_argument('--outputs', type=str, nargs='+', default=['clean_points'],
                                 help='outputs of the network')
        ...
        self.parser.add_argument('--cache_capacity', type=int, default=600,
