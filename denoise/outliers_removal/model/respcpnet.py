...
from denoise.outliers_removal.model.pcpnet import BasicBlock
...
class ResPointNetFeat(nn.Module):
    def __init__(self,
        ...
        # 对点云进行预处理，平移旋转缩放等操作，来保证训练模型更加鲁棒和稳定
...
class OutliersRemovalResPCPNet(nn.Module):
    def __init__(self, num_points=500,
                 ...
                 get_pointfvals=False,
                 point_tuple=1):
        super(OutliersRemovalResPCPNet, self).__init__()
        self.num_points = num_points
